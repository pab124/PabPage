...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
   ...
   <!--ebb: We use the collection() function in XSLT to refer to a file collection. That direction is a relative file path, and we step into it from the context of where saved this stylesheet. Look at the DHClass-Hub directory, and you'll see Sonnets-modal-coll.xsl sits just above the directory named sonnetsColl. You'll want to work on your assignments this way too, just for ease of processing.  --> 
